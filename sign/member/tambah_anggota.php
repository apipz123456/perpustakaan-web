<?php 
// Cek apakah tombol "Sign Up" telah ditekan
...
if(isset($_POST["signUp"])) {
    ...
    $query = "INSERT INTO anggota (no_induk, nama, jenis_kelamin, kelas, jurusan, no_tlp, tgl_pendaftaran)
              VALUES ('$no_induk', '$nama', '$jenis_kelamin', '$kelas', '$jurusan', '$no_tlp', '$tgl_pendaftaran')";
    ...
    if($result) {
        echo "<script>
                ...
                window.location.href = '/DashboardAdmin/member/member.php'; // Ganti /path/to/anggota_table.php dengan lokasi tabel anggota
              </script>";
    } else {
        echo "<script>
...
<body>
    <div class="container">
        <div class="card p-2 mt-5">
            ...
            <h1 class="pt-5 text-center fw-bold">Tambah Anggota</h1>
            <hr>
            <form action="" method="post" class="row g-3 p-4 needs-validation" novalidate>

                <label for="validationCustom01" class="form-label">No_Induk</label>
                <div class="input-group mt-0">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-hashtag"></i></span>
                    <input type="number" class="form-control" name="no_induk" id="validationCustom01" required>
                    <div class="invalid-feedback">
                        No_induk wajib diisi!
                    </div>
                </div>
                ...
                <div class="input-group mb-2">
                    ...
                    <select class="form-select" id="inputGroupSelect01" name="jurusan">
                        ...
                        <option value="Sistem Informatika Jaringan dan Aplikasi">Sistem Informatika Jaringan dan
                            Aplikasi</option>
                ...
                <div class="col-12">
                    <button class="btn btn-primary" type="submit" name="signUp" href="member/member.php">Tambah</button>
                </div>
            </form>
        </div>
