...
function tambahBuku($dataBuku) {
  ...
  $jumlah_buku = $dataBuku["jumlah_buku"];
  ...
  $queryInsertDataBuku = "INSERT INTO buku VALUES('$cover', '$idBuku', '$kategoriBuku', '$judulBuku','$jumlah_buku', '$pengarangBuku', '$penerbitBuku', '$tahunTerbit', $jumlahHalaman, '$deskripsiBuku')";
...
function searchMember ($keyword) {
   ...
   $searchMember = "SELECT * FROM anggota WHERE 
...
function deleteMember($no_induk) {
  global $connection;
  
  $deleteMember = "DELETE FROM anggota WHERE no_induk = $no_induk";
...
function pinjamBuku($dataBuku) {
  ...
  $no_induk = $dataBuku["no_induk"];
  $idAdmin = $dataBuku["id"];
  $tglPinjam = $dataBuku["tgl_peminjaman"];
  $tglKembali = $dataBuku["tgl_pengembalian"];
  // cek apakah user memiliki denda 
  $cekDenda = mysqli_query($connection, "SELECT denda FROM pengembalian WHERE no_induk = $no_induk && denda > 0");
  ...
  $queryPinjam = "INSERT INTO peminjaman VALUES(null, '$idBuku', $no_induk, $idAdmin, '$tglPinjam', '$tglKembali')";
...
function pengembalian($dataBuku) {
  ...
  $queryPengembalian = "INSERT INTO pengembalian VALUES(null, $idPeminjaman, '$idBuku', $no_induk, $idAdmin, '$bukuKembali', '$keterlambatan', $denda)";
